...
dieser Website ist:</p> <p>Philipp Anders<br />
Hauptstr. 26<br />
01920 Nebelsch&uuml;tz</p>
<p>Telefon: +4935783090203<br />
E-Mail: philipp.anders@decentnodes.de</p>
...
<h3>Klaro Consent Banner</h3>
<p>
Unsere Website nutzt die Consent-Technologie von Klaro.org, um Ihre Einwilligung zur Speicherung bestimmter Cookies auf Ihrem Endgerät oder zum Einsatz bestimmter Technologien einzuholen und diese datenschutzkonform zu dokumentieren. Anbieter dieser Technologie ist KIProtect GmbH, Bismarckstr. 10-12, 10625 Berlin (im Folgenden „Klaro Consent Banner“).

Klaro Consent Banner wird client-seitig ausgeführt, sodass keine Verbindung zu den Servern des Anbieters von Klaro Consent Banner hergestellt wird. Klaro Consent Banner speichert einen lokalen Cookie in Ihrem Browser, um Ihnen die erteilten Einwilligungen bzw. deren Widerruf zuordnen zu können. Die so erfassten Daten werden gespeichert, bis Sie uns zur Löschung auffordern, den Klaro Consent Banner-Cookie selbst löschen oder der Zweck für die Datenspeicherung entfällt. Zwingende gesetzliche Aufbewahrungspflichten bleiben unberührt.

Der Einsatz von Klaro Consent Banner erfolgt, um die gesetzlich vorgeschriebenen Einwilligungen für den Einsatz von Cookies einzuholen. Rechtsgrundlage hierfür ist Art. 6 Abs. 1 lit. c DSGVO.
</p>
...
<h3>Einsatz des Marketing-Tools Brevo</h3>
<p>
Wir verwenden auf unserer Website das Marketing-Tool Brevo (ehemals Sendinblue), ein Dienst der Sendinblue GmbH, Köpenicker Straße 126, 10179 Berlin, Deutschland, zur Verwaltung von E-Mail-Kampagnen, Newsletterversand, Formularen und automatisierten Marketingprozessen.

Rechtsgrundlage der Verarbeitung: Die Verarbeitung erfolgt auf Grundlage Ihrer Einwilligung gemäß Art. 6 Abs. 1 lit. a DSGVO, sofern Sie dieser explizit zugestimmt haben (z. B. durch Anmeldung zu unserem Newsletter). Sie können Ihre Einwilligung jederzeit mit Wirkung für die Zukunft widerrufen.

Zweck der Verarbeitung: Brevo ermöglicht es uns, mit Ihnen in Kontakt zu treten, Informationen zielgerichtet zu versenden und das Nutzerverhalten in Bezug auf unsere E-Mail-Kommunikation zu analysieren. Dazu gehören z. B. Informationen über Zustellbarkeit, Öffnungsraten und Klickverhalten.

Speicherung und Datenweitergabe: Die von Ihnen angegebenen Daten (z. B. Name, E-Mail-Adresse) werden auf den Servern von Brevo innerhalb der EU gespeichert. Brevo verpflichtet sich zur Einhaltung der geltenden Datenschutzgesetze und verarbeitet Ihre Daten ausschließlich auf unsere Weisung hin (Auftragsverarbeitung gemäß Art. 28 DSGVO).

Tracking-Funktionalitäten: Unsere E-Mails, die über Brevo versendet werden, enthalten sogenannte Zählpixel. Diese ermöglichen uns eine statistische Auswertung des Nutzerverhaltens. So können wir z. B. erkennen, ob eine E-Mail geöffnet wurde und welche Links angeklickt wurden. Wenn Sie dies nicht wünschen, können Sie der Nutzung widersprechen oder sich vom Newsletter abmelden.

Widerruf und Widerspruch: Sie können sich jederzeit über den in jeder E-Mail enthaltenen Abmeldelink von unseren Newslettern abmelden oder Ihre Einwilligung zur Verarbeitung Ihrer Daten durch Brevo widerrufen.
